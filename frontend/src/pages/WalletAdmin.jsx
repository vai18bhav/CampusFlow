  ...
  return (
    <div className="container py-5 text-center">
      <div className="card shadow border-0 p-5 mx-auto" style={{ maxWidth: '600px', borderRadius: '16px' }}>
        ...
        <h3 className="fw-bold mb-3">Wallet Admin Module Retired</h3>
        <p className="text-muted mb-4">
          The coin wallet management dashboard has been disabled in favor of direct currency-based invoicing (INR/USD) as per official requirements.
        </p>
        <div>
